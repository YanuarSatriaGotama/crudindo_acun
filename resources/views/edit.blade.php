      ...
      <div class="d-flex" id="wrapper" data-aos="fade-right">
        ...
        <div id="page-content-wrapper">
          ...
          >
			...
			<div class="container">
			<a href="/pegawai" class="btn btn-primary mb-5" >Kembali</a>
			...
			<form action="/pegawai/update" method="post">
				...
				Nama Barang<input type="text" required="required" name="nama" value="{{ $p->pegawai_nama }}"> <br/>
				Jenis Barang <input type="text" required="required" name="jabatan" value="{{ $p->pegawai_jabatan }}"> <br/>
				Stok <input type="number" required="required" name="umur" value="{{ $p->pegawai_umur }}"> <br/>
				Pegawai <textarea required="required" name="alamat">{{ $p->pegawai_alamat }}</textarea> <br/>
